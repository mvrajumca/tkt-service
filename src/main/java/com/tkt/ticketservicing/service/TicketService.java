...
public interface TicketService {
	 ...
	 */
	int numSeatsAvailable(Optional<Integer> venueLevel) throws TicketSystemException;
	 ...
	 */
	String reserveSeats(String seatHoldId, String customerEmail) throws TicketSystemException;
}
